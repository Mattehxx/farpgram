      ...
      <div class="main-container">
        ...
        <div class="row text-center mt-5 main">
          ...
          <div class="col-4 text-start card text-bg-dark d-inline-flex">
            <div class="card-body">
              <img src="../uploads/profileImages/Defalut_pfp.png" class="d-inline rounded-circle profile-image">
          ...
          <div class="col-4 text-start card text-bg-dark d-inline-flex comment-col">
            ...
            <div class="overflow-auto comments">
              <ul style="list-style: none">
                <li> <img src="../uploads/profileImages/Defalut_pfp.png" class="d-inline rounded-circle profile-image"> <a href="profile.php" class="accountToSearch text-decoration-none link">Marco</a> : <span class="comment-text text-break" > il mio commento </span> </li>
                <li> <img src="../uploads/profileImages/Defalut_pfp.png" class="d-inline rounded-circle profile-image"> <a href="profile.php" class="accountToSearch text-decoration-none link">Mattehxx</a> : <span class="comment-text text-break" > il mio commento </span> </li>
                <li> <img src="../uploads/profileImages/Defalut_pfp.png" class="d-inline rounded-circle profile-image"> <a href="profile.php" class="accountToSearch text-decoration-none link">Mattia</a> : <span class="comment-text text-break" > il mio commento </span> </li>
                <li> <img src="../uploads/profileImages/Defalut_pfp.png" class="d-inline rounded-circle profile-image"> <a href="profile.php" class="accountToSearch text-decoration-none link">Mattia</a> : <span class="comment-text text-break" > il mio commento </span> </li>
                <li> <img src="../uploads/profileImages/Defalut_pfp.png" class="d-inline rounded-circle profile-image"> <a href="profile.php" class="accountToSearch text-decoration-none link">Mattia</a> : <span class="comment-text text-break" > il mio commento </span> </li>
              </ul>
            </div>  
