          ...
          <div class="col-5">
              ...
              <div class="row">
                  ...
                  <div class="col" id="btnModProfile">
                      <button type="button" class="btn btn-primary rounded-pill position-relative top-50 translate-middle-y" data-bs-toggle="modal" data-bs-target="#exampleModal">Modifica</button>
                  </div>
              </div>
              <div class="row">
                <div class="col-2">
