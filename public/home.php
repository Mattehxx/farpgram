      ...
      <div class="container-fluid" id="inner-container">
        <div class="row">
          ...
          <aside class="sidebar">
            ...
            <div class="row">
              <a class="link" href="prova.php"><h4 class="link">Profilo</h4></a>
            </div>
            <div class="row">
          ...
          <div class="col-9" id="post">
            <div class="card text-bg-dark" style="width: 20rem">
              <div class="card-body">
                ...
                <h5 class="card-title d-inline"> <a href="profile.php" class="accountToSearch link">Mattehxx</a> </h5>
            ...
            <div class="card text-bg-dark" style="width: 20rem">
              <div class="card-body">
                <img src="Images\colorful.PNG" class="d-inline rounded-circle profile-image">
                <h5 class="card-title d-inline"> <a href="profile.php" class="accountToSearch link">Mattia</a> </h5>
                <p class="card-text">luogo</p>
              </div>
            ...
            <div class="card text-bg-dark" style="width: 20rem">
              <div class="card-body">
                <img src="Images\colorful.PNG" class="d-inline rounded-circle profile-image">
                <h5 class="card-title d-inline"> <a href="profile.php" class="accountToSearch link">Marco</a> </h5>
                <p class="card-text">luogo</p>
              </div>
              <img src="Images\Screenshot (5).png" class="card-img-top" alt="caricamento in corso">
              <div class="card-body">
