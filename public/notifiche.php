...
<head>
    ...
    <link rel="stylesheet" href="../styles/notificheStyle.css">
      ...
      <div class="container-fluid" id="inner-container">
        <div class="row">
          ...
          <aside class="sidebar">
            ...
            <div class="row">
              <a class="link" href="notifiche.php"><h4>Notifiche</h4></a>
            </div>
            <div class="row">
              <a class="link" href="#"><h4>Esplora</h4></a>
            </div>
            <div class="row">
              <a class="link" href="profilo.php"><h4>Profilo</h4></a>
            </div>
            <div class="row">
          ...
          <div class="col-9 " id="post">
            <ul>
                <li class="notification"> <img src="Images\colorful.PNG" class="d-inline rounded-circle profile-image me-3"> <h6 class="d-inline white me-3" >username ha messo mi piace al tuo post</h6> <img src="Images\novb.jpg" class="d-inline profile-image me-3"> <h6 class="d-inline grey me-3">30/11/2022</h6></li>
                <li class="notification"> <img src="Images\colorful.PNG" class="d-inline rounded-circle profile-image me-3"> <h6 class="d-inline white me-3" >username ha iniziato a seguirti</h6> <h6 class="d-inline grey me-3">30/11/2022</h6></li>
                <li class="notification"> <img src="Images\colorful.PNG" class="d-inline rounded-circle profile-image me-3"> <h6 class="d-inline white me-3" >username ha messo mi piace al tuo post</h6> <img src="Images\novb.jpg" class="d-inline profile-image me-3"> <h6 class="d-inline grey me-3">30/11/2022</h6></li>
            </ul>
          </div>
          <div class="col-1" id="profilo">
            <aside class="sidebar">
              <img src="Images\colorful.PNG" class="rounded-circle position-relative top-0 start-50 translate-middle-x profile-image">
