...
const textField = document.getElementById("text_field") // Prendo l'elemento con ID="text_field" dall'html
...
textField.addEventListener("input",  function() {
    ...
    request.onload = () => {    
        ...
        jsonResponse['features'].forEach(element => {  // Andiamo dentro ogni oggetto 'feature' del JSON
            var placeNode = document.createElement('p') // Creiamo un elemento con il tag <p>
...
function getCurrentPosition() {
    ...
    request.onload = () => {    
        ...
        var placeNode = document.createElement('p'); // Creiamo un elemento con il tag <p>
        placeNode.innerHTML = jsonResponse['city']['name'];  // Aggiungiamo questo testo nel paragrafo
        locations.appendChild(placeNode);    // Aggiungiamo il paragrafo nell'html
    }
}